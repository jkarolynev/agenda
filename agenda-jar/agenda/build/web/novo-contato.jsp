        ...
        <div class="corpo" style="margin-top: 0">
            <form class="div-body" action='home.jsp'>
                <div class="col-sm-12">
                    ...
                    <h5 style="font-size: 16px; margin-bottom: 16px">Preencha os campos abaixos para registrar um novo contato</h5>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <button type="submit" class="btn btn-primary" style="width: 20%; margin-bottom: 2%; background-color:  #e600ac; border: none; float: right" onclick="location.href = 'home.jsp'">Novo contato</button>   
                </div>
            </form>
        </div>
    </body>
